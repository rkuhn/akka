...
public class FlowGraphTest extends StreamTest {
  ...
  public void mustBeAbleToUseZip() {
    ...
    b.addEdge(b.add(in1), zip.in0());
    b.addEdge(b.add(in2), zip.in1());
    b.addEdge(zip.out(), b.add(out));
    b.run(materializer);
  ...
  public void mustBeAbleToUseUnzip() {
    ...
    final Builder b = FlowGraph.builder();
    final Outlet<Pair<String, Integer>> in = b.add(Source.from(input));
    ...
    b.addEdge(in, unzip.in());
    b.addEdge(unzip.out0(), b.add(out1));
    b.addEdge(unzip.out1(), b.add(out2));
    b.run(materializer);
  ...
  public void mustBeAbleToUseZip4With() throws Exception {
    ...
    final Future<Integer> future = FlowGraph.factory().closed(Sink.<Integer> head(), new Procedure2<Builder, SinkShape<Integer>>() {
      ...
      public void apply(Builder b, SinkShape<Integer> out) throws Exception {
        ...
        b.addEdge(b.add(in1), zip.in0());
        b.addEdge(b.add(in2), zip.in1());
        b.addEdge(b.add(in3), zip.in2());
        b.addEdge(b.add(in4), zip.in3());
        b.addEdge(zip.out(), out.inlet());
      }
    }).run(materializer);
